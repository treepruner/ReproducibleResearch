...
fatalities <- xtable(sd_pop_fatalities )
print(fatalities, type="html")


injuries <- xtable(sd_pop_injuries )
print(injuries, type="html")

```


```{r pop_stats, echo = TRUE,  results="asis"}
sd_PropertyDamageAmt <- 
        sd %>% 
        group_by(EnvTypeGroup) %>% 
        summarise(n_date = n()
                  , sum_PropertyDamageAmt = sum(PropertyDamageAmt) 
                  , mean_PropertyDamageAmt = mean(PropertyDamageAmt)
                  , median_PropertyDamageAmt = median(PropertyDamageAmt)
                  , min_PropertyDamageAmt = min(PropertyDamageAmt)
                  , max_PropertyDamageAmt = max(PropertyDamageAmt)
        )
...
sd_CropDamageAmt <- 
        ...
        group_by(EnvTypeGroup) %>% 
        summarise(n_date = n()
                  , sum_CropDamageAmt = sum(CropDamageAmt) 
                  , mean_CropDamageAmt = mean(CropDamageAmt)
                  , median_CropDamageAmt = median(CropDamageAmt)
                  , min_CropDamageAmt = min(CropDamageAmt)
                  , max_CropDamageAmt = max(CropDamageAmt)
        )
...
PropertyDamageAmt <- xtable(PropertyDamageAmt )
print(PropertyDamageAmt, type="html")


CropDamageAmt <- xtable(sd_CropDamageAmt )
print(CropDamageAmt, type="html")
