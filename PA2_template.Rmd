...
fatalities <- xtable( prettyNum(pop_fatalities[pop_fatalities$Fatalities.Count != 0,], big.mark = ",", preserve.width = "none"), digits =  c(0,0,0,0,0,0,0,0) )
...
The top "Fatalities by Event Groups by Year" figure presented below shows that the data may be incomplete or have quality issues since there are no flooding or heat related deaths prior to 1990.
...
ggplot( data = pop_fatalities_yr
        ...
        ggtitle("Figure 1: Fatalities by Event Groups by Year")
```
...
injuries <- xtable(prettyNum(pop_injuries[pop_injuries$Injuries.Count != 0,], big.mark = ",", preserve.width = "none"), digits = c(0,0,0,0,0,0,0,0) )
...
ggplot( data = pop_injuries_yr
        ...
        geom_line() + 
        theme(legend.position = "bottom") +
        ggtitle("Figure 2: Injuries by Event Groups by Year")
...
PropertyDamage <- xtable(prettyNum(cost_PropertyDamage[cost_PropertyDamage$PropertyDamageAmt.Sum != 0,], big.mark = ",", preserve.width = "none"), digits = c(0,0,0,0,0,0,0,0) ) 
...
PropertyDamageHigh <- xtable(prettyNum(cost_PropertyDamage_High[cost_PropertyDamage_High$PropertyDamageAmt.Sum != 0,], big.mark = ",", preserve.width = "none"), digits = c(0,0,0,0,0,0,0,0) )
...
CropDamage <- xtable(prettyNum(cost_CropDamage[cost_CropDamage$CropDamageAmt.Sum != 0,], big.mark = ",", preserve.width = "none"), digits = c(0,0,0,0,0,0,0,0) ) 
